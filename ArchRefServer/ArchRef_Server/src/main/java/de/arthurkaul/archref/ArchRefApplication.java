 ...
 * 
 * @hint: After programming a first prototype of a architectural refinement tool it may be a better idea to use a graph store for handel the data because of the level graph concept which is
 *        implemented with ArchRef the level graph.
 * 
