...
$__System.register("2", ["3"], function (exports_1, context_1) {
    ...
    var core_1, ContextmenuComponent, _a, _b;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
...
$__System.register("4", ["3"], function (exports_1, context_1) {
    ...
    var __moduleName = context_1 && context_1.id;
    var core_1, ContextmenuDirective;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
...
$__System.register("1", ["3", "5", "2", "4"], function (exports_1, context_1) {
    "use strict";
    var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
        var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
        if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    ...
    var __moduleName = context_1 && context_1.id;
    var core_1, platform_browser_1, contextmenu_component_1, contextmenu_directive_1, ContextmenuModule;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            ...
            exports_1("ContextmenuModule", ContextmenuModule);
        }
    };
});
