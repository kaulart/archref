...
export class RelationshipTemplateService {
  ...
  public extractRelationshipTemplateDataList(res) {
    ...
    for (let relationshipTemplate of body) {
      let tempRelationshipTemplate: RelationshipTemplate = new RelationshipTemplate(relationshipTemplate.name, relationshipTemplate.sourceNodeId, relationshipTemplate.targetNodeId, relationshipTemplate.path, relationshipTemplate.relationshipTypeId, relationshipTemplate.topologyTemplateId);
  ...
  private extractRelationshipTemplateData(res: Response) {
    ...
    let body = res.json();
    Logger.data('[RESPONSE - RELATIONSHIPTEMPLATE]: ' + JSON.stringify(body), RelationshipTemplateService.name);
    let relationshipTemplate: RelationshipTemplate = new RelationshipTemplate(body.name, body.sourceNodeId, body.targetNodeId, body.path, body.relationshipTypeId, body.topologyTemplateId);
